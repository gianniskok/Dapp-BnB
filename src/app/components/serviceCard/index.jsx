...
import Greeter from '/home/giannis/react-project101/my-app/src/artifacts/contracts/Greeter.sol/Greeter.json';
...
const apartmentAddress = "0x5fbdb2315678afecb367f032d93f642f64180aa3";
...
export function ServiceCard(props) {
    ...
    async function createApartment() {
        ...
        if( typeof window.ethereum !== 'undefined') {
            ...
            const provider = new ethers.providers.Web3Provider(window.ethereum);
            const signer = provider.getSigner()
            const contract = new ethers.Contract(apartmentAddress, ApartmentCreator.abi, signer)
            const transaction = await contract.createApartment(price)
            await transaction.wait()
            getApartmentPrice(getApartmentPrice.length)
    ...
    async function getApartmentPrice() {
        ...
        if(typeof window.ethereum !== 'undefined' ){
            const provider = new ethers.providers.Web3Provider(window.ethereum)
            const contract = new ethers.Contract(apartmentAddress, ApartmentCreator.abi, provider)
            try { 
        ...
        <CardContainer>
            ...
            <FooterContainer>
                ...
                <ButtonsContainer onClick={createApartment}>
                    <Button text="Set Price Of Apartment"/>
                </ButtonsContainer>
                <PriceContainer>
